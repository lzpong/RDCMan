...
namespace RdcMan
{
	public static class FormTools
	{
		...
		{
			return new Point(16 + 140 * colIndex, YPos(rowIndex));
		}

		public static Label NewLabel(string text, int colIndex, int rowIndex)
		{
			Label label = new Label();
			label.Location = NewLocation(colIndex, rowIndex);
			label.Text = text;
		...
		{
			return NewCheckBox(text, colIndex, rowIndex, tabIndex, 340);
		}
		...
		public static TabPage NewTabPage(string name)
		{
			...
			tabPage.Location = TopLeftLocation();
			tabPage.Size = new Size(512, 334);
			tabPage.Text = name;
