...
namespace RdcMan {
	internal class ServerPropertiesTabPage : NodePropertiesPage<ServerSettings> {
		...
		public ServerPropertiesTabPage(TabbedSettingsDialog dialog, ServerSettings settings)
			...
			int num = 0;
			int rowIndex = 0;
			_displayNameTextBox = FormTools.AddLabeledTextBox(this, "显示名称(&D)：", base.Settings.DisplayName, ref rowIndex, ref num);
			...
			_serverNameTextBox = FormTools.AddLabeledTextBox(this, "服务器地址(&S)：", base.Settings.ServerName, ref rowIndex, ref num);
