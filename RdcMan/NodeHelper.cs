...
namespace RdcMan
{
	internal static class NodeHelper
	{
		...
		{
			RdpClient.ConnectionState[] completionStates = new RdpClient.ConnectionState[1];
			ThrottledOperation(servers, completionStates, delegate(ServerBase server)
			{
				server.Disconnect();
			}, 25);
		}
