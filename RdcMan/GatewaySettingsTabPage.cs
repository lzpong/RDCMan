...
namespace RdcMan {
	public class GatewaySettingsTabPage : CredentialsTabPage<GatewaySettings> {
		...
		public void CreateControls(LogonCredentialsDialogOptions options) {
			...
			_useGatewayServerCheckBox = FormTools.AddCheckBox(this, "使用 TS 网关服务器(&U)", base.Settings.UseGatewayServer, 1, ref rowIndex, ref num);
			_useGatewayServerCheckBox.CheckedChanged += UseGatewayServerCheckBox_CheckedChanged;
			_gatewayHostNameTextBox = FormTools.AddLabeledTextBox(this, "服务器名称(&S)：", base.Settings.HostName, ref rowIndex, ref num);
